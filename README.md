...
![mojieのサムネイル](./package-thumb.gif "サムネイル")
...
### GitHub Releaseから
1. [GitHub Release](https://github.com/ronin-gw/aviutl2_mojie/releases)から `mojie.aux2` と `mojieテキスト.object` をダウンロードします。
2. AviUtl2を終了します。
...
4. AviUtl2を起動します。
5. 初回だけ未確認プラグインの読み込み確認が表示された場合は、mojieの読み込みを許可します。
6. 「設定 → プラグイン設定 → mojie」が表示されることを確認します。
